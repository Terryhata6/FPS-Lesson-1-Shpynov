...
namespace Game
{
    public sealed class UnitMotor : IMotor
    {
        ...
        public Transform Instance { get; private set; } //используется для сохранения
        ...
        private void LookRotation(Transform character, Transform camera)
        {
            ...
            _characterTargetRot *= Quaternion.Euler(0.0f, yRot, 0.0f);
            _cameraTargetRot *= Quaternion.Euler(-xRot, 0.0f, 0.0f);
